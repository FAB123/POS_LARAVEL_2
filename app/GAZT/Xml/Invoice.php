...
class Invoice implements XmlSerializable
{
     ...
     * @return string
     */
    public function getInvoiceBillTypeCode(): ?string
    {
        return $this->invoiceBillTypeCode;
    }

    /**
     * @param string $invoiceBillTypeCode
     * See also: src/InvoiceTypeCode.php
     * @return Invoice
     */
    public function setInvoiceBillTypeCode(string $invoiceBillTypeCode): Invoice
    {
        $this->invoiceBillTypeCode = $invoiceBillTypeCode;
        return $this;
    }
     ...
     * @return Invoice
     */
    public function setInvoiceTaxTotal(TaxTotal $invoiceTaxTotal): Invoice
    {
     ...
     * @return Invoice
     */
    public function setAdditionalDocumentReference(array $additionalDocumentReference): Invoice
    {
    ...
    public function xmlSerialize(Writer $writer): void
    {
        ...
        $writer->write([
            [
                ...
                "value" => $this->invoiceBillTypeCode,
                "attributes" => [
                    "name" => $this->invoiceTypeCode,
                ],
            ],
        ]);
        // // }
        ...
        if ($this->additionalDocumentReference !== null) {
            foreach ($this->additionalDocumentReference as $additionalDocument) {
                $writer->write([
                    Schema::CAC . 'AdditionalDocumentReference' => $additionalDocument,
                ]);
            }
        }
        ...
        if ($this->invoiceTaxTotal !== null) {
            $writer->write([
                Schema::CAC . 'TaxTotal' => $this->invoiceTaxTotal,
            ]);
        }
